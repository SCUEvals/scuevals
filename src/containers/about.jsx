...
import { userInfoPT } from '../utils/propTypes';
      ...
      <div className="row">
        <div className="col-sm-6">
          <button
            ...
            data-target="#webAppDesc"
            aria-expanded="false"
            aria-controls="webAppDesc"
          >
          ...
          <div className="collapse" id="webAppDesc">
            <div className="card card-body">
              <p>
                The web app is built from {'Facebook\'s '}
                <a href="https://facebook.github.io/react/">React</a> combined {'with '}
                <a href="http://redux.js.org">Redux</a> and Redux middleware. For URL navigation
                of the single page web app,
                <a href="https://github.com/ReactTraining/react-router"> React Router</a> is used.
                Because it is written with {'JavaScript\'s'} new release ES6, the web app
                uses <a href="https://babeljs.io">Babel</a> to translate ES6 code into ES5 code
                for better compatibility between browsers, {'uses '}
                <a href="https://webpack.js.org">Webpack</a> to do things like compiling SCSS and
                running code through Babel for transformation, and {'uses '}
                <a href="https://expressjs.com">Express</a> to configure the server. For managing
                packages, <a href="https://www.npmjs.com/">npm</a> is used. For design purposes
                and browser flexibility, the web app uses a CDN for {'the '}
                <a href="https://getbootstrap.com/">Bootstrap</a> {'framework. '}
                <a href="http://sass-lang.com/">SCSS</a> is implemented for consistent,
                compressed, and programmatic creation of CSS.
              </p>
              <h6>
                Check it out at the
                <a href="https://github.com/SCUEvals/scuevals"> GitHub repository.</a>
              </h6>
            </div>
          </div>
        </div>
        <div className="col-sm-6">
          <button
            ...
            type="button"
            data-toggle="collapse"
            data-target="#databaseDesc"
            aria-expanded="false"
            aria-controls="databaseDesc"
          >
          ...
          <div className="collapse" id="databaseDesc">
            <div className="card card-body">
              <p>
                The back-end is built on a core of <a href="https://www.python.org/">Python</a>
                with <a href="http://flask.pocoo.org/">Flask</a>. All the data is stored in {'a '}
